...
export const fr = (p: Tools): Messages => ({
    ...
    auth: {
        ...
        captchaNaoCarregou:
            'La vérification indiquant que vous n’êtes pas un robot n’a pas pu se charger. Rechargez la page pour réessayer : sans elle, impossible de continuer.',
    ...
    servidores: {
        ...
        actividadeTitulo: 'Qui était là, heure par heure',

        mediaDeSete: 'en moyenne, ces 7 derniers jours',

        picoDeSete: 'à l\u2019heure la plus chargée',

        semDados: 'rien de signalé',

        mediaDe: (n: number) => `${n} en moyenne`,

        ordens: {
            newest: 'Les plus récents',
            active: 'Où il y a du monde',
        },

        tiraDescricao: (horas: number, media: number, pico: number) =>
            `Combien de personnes étaient là ces ${horas} dernières heures. ${media} en moyenne ces 7 derniers jours, ${pico} à l\u2019heure la plus chargée.`,
    ...
    planos: {
        ...
        server_base: 'Serveur',
        server_plus: 'Serveur +',
        server_unlimited: 'Serveur illimité',
    },
    ...
    erros: {
        ...
        CAPTCHA_FAILED: 'La vérification indiquant que vous n\'êtes pas un robot a échoué. Réessayez.',
    ...
    moderacao: {
        ...
        razoes: {
            ...
            off_topic: 'Ce n\'est pas la place pour ça',
            other: 'Autre chose',
        },
    ...
    forum: {
        ...
        fechar: 'Fermer aux réponses',

        reabrir: 'Rouvrir aux réponses',

        naoFoiPossivelFechar: 'Impossible de changer cela.',
    ...
    noticias: {
        ...
        titulo: 'Ce qui se passe dans le jeu',
    ...
    perfil: {
        ...
        reputacaoDeOnde: 'D\'où vient ta réputation',
        reputacaoVazia: 'Rien pour l\'instant. La réputation vient des événements : te présenter à un événement où quelqu\'un t\'a confirmé rapporte un point, t\'inscrire sans venir en coûte un.',
        reputacaoApareceu: 'tu étais là',
        reputacaoFaltou: 'tu n\'étais pas là',
        reputacaoEventoApagado: 'un événement qui n\'existe plus',
        conta: 'Compte',
        confirmado: 'Confirmé',
    ...
    rasto: {
        titulo: 'Ce qui a été décidé ici',
        aindaNada: 'Rien n’a encore été décidé sur personne.',
        contaApagada: 'un compte supprimé',
        alguem: 'quelqu’un',
        semCargo: 'sans rôle',
        admitiu: (quem: string, alvo: string) => `${quem} a fait entrer ${alvo}`,
        recusou: (quem: string, alvo: string) => `${quem} a refusé ${alvo}`,
    ...
    tesouraria: {
        ...
        transferirAviso:
            'Ce qu’un serveur gagne finance les crews qui y jouent. Cela bouge tout de suite — c’est ta propre trésorerie qui paie.',
        paraQueCrew: 'À quelle crew',
        escolheCrew: 'Choisis une crew',
        semCrewsNoServidor:
            'Aucune crew ne joue encore ici. Accepte-en une et tu pourras la financer d’ici.',
        transferir: 'Envoyer',
        aTransferir: 'Envoi…',
        transferida: 'Envoyé.',
